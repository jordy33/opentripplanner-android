...
package mx.com.madd.opentripplanner.android.tasks;
...
import mx.com.madd.opentripplanner.android.exceptions.ServerListParsingException;
...
import static mx.com.madd.opentripplanner.android.OTPApp.PREFERENCE_KEY_AUTO_DETECT_SERVER;
import static mx.com.madd.opentripplanner.android.OTPApp.PREFERENCE_KEY_CUSTOM_SERVER_URL;
import static mx.com.madd.opentripplanner.android.OTPApp.PREFERENCE_KEY_CUSTOM_SERVER_URL_IS_VALID;
import static mx.com.madd.opentripplanner.android.OTPApp.PREFERENCE_KEY_SELECTED_CUSTOM_SERVER;
import static mx.com.madd.opentripplanner.android.OTPApp.PREFERENCE_KEY_SELECTED_SERVER;
...
public class ServerSelector extends AsyncTask<LatLng, Integer, Integer>
    ...
    protected Integer doInBackground(LatLng... latLng) {
        ...
        if (serverList == null || serverList.isEmpty() || mustRefreshList) {
            ...
            Log.e(OTPApp.TAG, "link:"+R.string.servers_spreadsheet_url);
                    ...
                    if (allFieldsNotNull && (serverString.length >= 9)) {
                        try {
                            Server s = new Server(currentTime, serverString[0], serverString[1],
                                    ...
                                    serverString[8]);
                            Log.d(OTPApp.TAG,serverString[0]);
                            Log.d(OTPApp.TAG,serverString[1]);
                            Log.d(OTPApp.TAG,serverString[2]);
                            Log.d(OTPApp.TAG,serverString[3]);
                            Log.d(OTPApp.TAG,serverString[4]);
                            Log.d(OTPApp.TAG,serverString[5]);
                            Log.d(OTPApp.TAG,serverString[6]);
                            Log.d(OTPApp.TAG,serverString[7]);
                            Log.d(OTPApp.TAG,serverString[8]);
            ...
            if (activityRetrieved != null) {
                ...
                */
                ...
                ServerChecker serverChecker
                        ...
                        true, false);
                serverChecker.execute(
                        new Server("http://otp.dwim.mx:8080/otp", context));
                prefsEditor.commit();
                //
                selectedCustomServer = true;
            }
