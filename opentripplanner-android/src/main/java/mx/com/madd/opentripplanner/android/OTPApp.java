...
public class OTPApp extends Application {
    ...
    public static final String INTENT_UPDATE_BIKE_RENTAL_ACTION
            = "mx.com.madd.opentripplanner.android.OpenTripPlanner.UPDATE_BIKE_RENTAL";

    public static final String INTENT_UPDATE_TRIP_TIME_ACTION
            = "mx.com.madd.opentripplanner.android.OpenTripPlanner.UPDATE_TRIP_TIME";

    public static final String INTENT_NOTIFICATION_ACTION_OPEN_APP
            = "mx.com.madd.opentripplanner.android.OpenTripPlanner.NOTIFICATION_OPEN_APP";

    public static final String INTENT_NOTIFICATION_ACTION_DISMISS_UPDATES
            = "mx.com.madd.opentripplanner.android.OpenTripPlanner.NOTIFICATION_DISMISS_UPDATES";

    public static final String INTENT_NOTIFICATION_RESUME_APP_WITH_TRIP_ID
            = "mx.com.madd.opentripplanner.android.OpenTripPlanner.NOTIFICATION_RESUME";
